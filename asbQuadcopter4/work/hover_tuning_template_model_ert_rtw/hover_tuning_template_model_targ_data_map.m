  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% ay1fvtxw3vr.iaerhrjrgiy.eo2v4coqpd
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ay1fvtxw3vr.iaerhrjrgiy.fsqkx2v3fl
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 2;
	
	  ;% ay1fvtxw3vr.iaerhrjrgiy.bdnurhg0xw
	  section.data(4).logicalSrcIdx = 4;
	  section.data(4).dtTransOffset = 4;
	
	  ;% ay1fvtxw3vr.iaerhrjrgiy.ljggdjqfmw
	  section.data(5).logicalSrcIdx = 7;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% fffknzztmme.iaerhrjrgiy.ecuqz2pkp4.LoggedData
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 2;
	
	  ;% fffknzztmme.iaerhrjrgiy.afm12z5ssr.LoggedData
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 4;
	  ...
	  ;% fffknzztmme.iaerhrjrgiy.jbwbrldwvh.LoggedData
	  section.data(6).logicalSrcIdx = 15;
	  section.data(6).dtTransOffset = 6;
	
	  ;% fffknzztmme.iaerhrjrgiy.n1jj1qe05u.LoggedData
	  section.data(7).logicalSrcIdx = 16;
	  section.data(7).dtTransOffset = 9;
  ...
  targMap.checksum0 = 3629246072;
  targMap.checksum1 = 3949022942;
  targMap.checksum2 = 2158092188;
  targMap.checksum3 = 964732561;
