...
## Generated on : Thu Jun 03 15:02:49 2021
...
START_DIR                 = D:/Semester_2/Guidance_Navigation_and_Control/GNC_Project/Landmark_navigation_vison/new_drone_project/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/template_drone.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/template_drone_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
...
OBJS = rsedu_image.o rtGetInf.o rtGetNaN.o rt_nonfinite.o template_drone.o template_drone_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o rtiostream_interface.o rtiostream_tcpip.o mem_mgr.o
...
%.o : $(START_DIR)/template_drone_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/template_drone_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
template_drone.o : $(START_DIR)/template_drone_ert_rtw/template_drone.c
	$(CC) $(CFLAGS) -o "$@" "$<"


template_drone_data.o : $(START_DIR)/template_drone_ert_rtw/template_drone_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
